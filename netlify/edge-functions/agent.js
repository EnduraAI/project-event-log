...
export function truncateContext(context) {
  ...
  const ALLOW = new Set(["days","totals","ctype","cats","wbs","allowance","rov","user","generatedAt","selectedDay","latestLoggedDay","todayDate","currentDay","project","meta","stats","cycles"]);
