...
export function buildSystemPrompt() {
  return [
    ...
    "context.cycles, when present, is the recovery-cycle register: reels in recovery order (seq), integer minutes per canonical step, cycle totals from reel start to offload, lengths, weights and productivity in m/hr, plus per-flowline norms with mean, best, first, last and change percent. Use it for learning-curve, norm, productivity and reel-to-reel questions, chart it with pelchart when asked, compare like with like (same flowline or activity type), and state plainly when reels are incomplete or planned.",
